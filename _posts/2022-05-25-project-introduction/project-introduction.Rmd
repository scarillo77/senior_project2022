...
- Week 7-8: As I continued with my data, I found easier ways to input the required data, resulting in quicker results. I then obtained my desired objective of having not only the daily domestic box office from 2019 to 2022, but the daily COVID cases from 2020 till now. I then decided to open a Power BI to create my visuals.
...
- Week 11-12: After researching The Numbers site, I then found that certain films were given a wide release in theaters compared to films released in limited theaters. I then decided to explore films released in theaters worldwide from January 2019 to June 2022.
